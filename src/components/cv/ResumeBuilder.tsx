...
export function ResumeBuilder() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 bg-white shadow-lg rounded-lg print:shadow-none print:p-4">
      ...
      {/* Restructured to prioritize important content on first page for printing */}
      <div className="mt-8">
        {cvData.summary && (
          <Section title="Summary" icon={<User size={20} />}>
            <div className="text-sm leading-relaxed mb-4 text-gray-700 p-3 bg-gray-50 rounded-md print:bg-white">
              {cvData.summary}
            </div>
          </Section>
        )}

        {/* Skills section moved before work experience as requested */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 print:gap-4 mb-6">
